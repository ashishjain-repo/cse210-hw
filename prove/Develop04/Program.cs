    ...
    static void Main(string[] args)
    {
        ...
        while (mainLoop)
        {
            ...
            if (choiceOption == 1)
            {
                ...
                Description =
                    "This activity will help you realax by walking you through breathing in and out slowly. Clear your mind and focus on your breathing.";
                BreathingActivity breathing = new BreathingActivity(StartingMessage, EndingMessage, ActivityName,
            ...
            else if (choiceOption == 2)
            {
                ...
                ReflectionActivity reflection = new ReflectionActivity(StartingMessage, EndingMessage, ActivityName,
                    Description, Duration);
            ...
            else if (choiceOption == 3)
            {
                ...
                ListingActivity listing =
                    new ListingActivity(StartingMessage, EndingMessage, ActivityName, Description, Duration);
